...
ggplot(Kazakhstan_Gov, aes(x = year, y = score, group = index)) +
  geom_line(aes(linetype= "dash", color = index)) +
  geom_point(aes(color = index)) +
  labs(
    color = "Index",
...
ggplot(Kazakhstan_GDP, aes(x = year, y = gdp, color = "red")) +
  geom_point() +
  geom_line() +
  labs(
...
ggplot(Tajikistan_Gov, aes(x = year, y = score, group = index)) +
  geom_line(aes(linetype= "dash", color = index)) +
  geom_point(aes(color = index)) +
  labs(
    color = "Index",
...
ggplot(Tajikistan_GDP, aes(x = year, y = gdp, color = "red")) +
  geom_point() +
  geom_line() +
  labs(
...
ggplot(Uzbekistan_Gov, aes(x = year, y = score, group = index)) +
  geom_line(aes(linetype= "dash", color = index)) +
  geom_point(aes(color = index)) +
  labs(
    color = "Index",
    title = "Governance in Uzbekistan",
    x = "Year",
    y = "Index Score"
  ) +
  expand_limits(y = 100, x = "2020") +
...
ggplot(Uzbekistan_GDP, aes(x = year, y = gdp, color = "red")) +
  geom_point() +
  geom_line() +
  labs(
...
ggplot(Ecuador_Gov, aes(x = year, y = score, group = index)) +
  geom_line(aes(linetype= "dash", color = index)) +
  geom_point(aes(color = index)) +
  labs(
    color = "Index",
...
ggplot(Ecuador_GDP, aes(x = year, y = gdp, color = "red")) +
  geom_point() +
  geom_line() +
  labs(
